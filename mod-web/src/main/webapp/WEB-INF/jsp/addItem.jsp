...
<div class="well well-sm" ng-init="refresh()" style="padding: 25px">
    ...
    <form name="form" ng-show="formVis" ng-submit="addItem()" role="form" novalidate>
        <div class="row"><%-- szeroki panel--%>
            ...
            <div class="col-md-5 col-md-offset-2"><%-- prawo--%>
                <div class="text-right">
                    <h1><spring:message code="addItem.title.newOffer"/> </h1>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <button type="submit" ng-disabled="form.$invalid" class="btn btn-lg btn-default btn-block borromColour"><spring:message code="addItem.button.add"/></button>
                </div>
            </div>
        </div>
    </form>
    ...
    <div class="text-center linkBorrom" ng-show="regOk" ng-click='goLink("/myAds")'>
        <h4>
            <spring:message code="addItem.afterOk"/>
        </h4>
    </div>

    <div class="text-center" ng-show="regError" >
        <spring:message code="addItem.afterError"/>
    </div>
